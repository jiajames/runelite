...
public enum ConstructionMode
{
	...
	LARDER_EASY("Larders (easy)",
			newBaseComparableEntry("Remove", "larder <col=ff9040>(easy!)<col=ffffff>", -1, -1, true, false),
			newBaseComparableEntry("Build", "Larder space <col=ff9040>(easy!)<col=ffffff>", -1, -1, true, true)),
	MYTH_CAPE("Myth Cape",
